...
TEST(Constructor, base_string){
    EXPECT_EQ(uint256_t(16, "ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), uint256_max);
    EXPECT_EQ(uint256_t(10, "115792089237316195423570985008687907853269984665640564039457584007913129639935"), uint256_max);
    EXPECT_EQ(uint256_t(2, ""), uint256_max);
    EXPECT_EQ(uint256_t(10, "0"), 0);
    EXPECT_EQ(uint256_t(16, "0123456789abcdef"), 0x0123456789abcdefULL);
    EXPECT_EQ(uint256_t(8, "755"), 0x01ed);
    EXPECT_EQ(uint256_t(10, "31415926"), 0x01df5e76ULL);
}
